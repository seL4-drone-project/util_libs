...
/* The input frequence is the CPU frequency which is 40MHz by default */
#define APB_TIMER_INPUT_FREQ (40*1000*1000)
#define APB_TIMER_PADDR   0x10050000
